...
//
//    Cmdline:
//        sokol-shdc --input=C:\Users\Wasiq Arbab\Desktop\Projects\3GL\src\shaders\test-shader.glsl --output=.\src\shaders\build\test-shader.zig --slang=glsl430:wgsl:hlsl5:metal_macos --format=sokol_zig --bytecode
//
//    Overview:
//    =========
