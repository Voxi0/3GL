...
//
//    Cmdline:
//        sokol-shdc --input=C:\Users\Wasiq Arbab\Desktop\Projects\LearningSokol\src\shaders\test-shader.glsl --output=.\src\shaders\build\test-shader.zig --slang=glsl430:wgsl:hlsl5:metal_macos --format=sokol_zig --bytecode
//
//    Overview:
//    =========
...
//
//
const fs_source_glsl430 = [133]u8 {
...
//    void vert_main()
//    {
//        gl_Position = mul(position, _19_pvm);
//        color = color0;
//    }
//
...
//    }
//
const vs_bytecode_hlsl5 = [916]u8 {
    0x44,0x58,0x42,0x43,0xec,0x3c,0x0b,0x94,0xd7,0xd8,0xe8,0x75,0x64,0x3a,0xb3,0xb5,
    0xa3,0xd3,0x7f,0xa0,0x01,0x00,0x00,0x00,0x94,0x03,0x00,0x00,0x05,0x00,0x00,0x00,
    ...
    0x00,0x00,0x00,0x00,0x5f,0x31,0x39,0x5f,0x70,0x76,0x6d,0x00,0x66,0x6c,0x6f,0x61,
    ...
    0x00,0x00,0x00,0x00,0x46,0x1e,0x10,0x00,0x01,0x00,0x00,0x00,0x38,0x00,0x00,0x08,
...
//    }
//
const fs_bytecode_hlsl5 = [488]u8 {
...
//    {
//        main0_out out = {};
//        out.gl_Position = _19.pvm * in.position;
//        out.color = in.color0;
//        return out;
//    }
//
...
const vs_source_metal_macos = [509]u8 {
    ...
    0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x70,0x76,0x6d,0x3b,0x0a,0x7d,0x3b,0x0a,
    ...
    0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x5f,0x31,0x39,0x2e,0x70,0x76,0x6d,0x20,0x2a,
...
const vs_source_wgsl = [766]u8 {
    ...
    0x20,0x70,0x76,0x6d,0x20,0x3a,0x20,0x6d,0x61,0x74,0x34,0x78,0x34,0x66,0x2c,0x0a,
    ...
    0x31,0x39,0x2e,0x70,0x76,0x6d,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,
...
const fs_source_wgsl = [372]u8 {
    ...
    0x0a,0x20,0x20,0x66,0x72,0x61,0x67,0x43,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x78,
    0x5f,0x31,0x32,0x3b,0x0a,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,0x3b,0x0a,0x7d,
    0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,0x6d,0x61,0x69,0x6e,0x5f,0x6f,0x75,
...
pub fn triangleShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        ...
        .D3D11 => {
            ...
            desc.vertex_func.bytecode.size = 916;
            desc.vertex_func.entry = "main";
